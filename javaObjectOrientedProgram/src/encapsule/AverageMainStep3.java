...
public class AverageMainStep3 {
	public static void main(String[] args) {
		 ...
		 * new 는 생성자 키워드
		 * AverageVOStep3 클래스 이름과 동일하지만 끝에 메소드 표시() 가 있는 것은 생성자
		 */
		...
		System.out.println("hulk의 합계 : " + hulk.getTot());
		System.out.println("hulk의 평균 : " + hulk.getAvg());
		System.out.println("==="+iron.getName()+"의 성적표===");
		System.out.println("국어 :" + iron.getKor());
		System.out.println("영어 :" + iron.getEng());
		System.out.println("iron의 합계 : " + iron.getTot());
		System.out.println("iron의 평균 : " + iron.getAvg());
		System.out.println("==="+hawk.getName()+"의 성적표===");
		System.out.println("국어 :" + hawk.getKor());
		System.out.println("영어 :" + hawk.getEng());
		System.out.println("hawk의 합계 : " + hawk.getTot());
		System.out.println("hawk의 평균 : " + hawk.getAvg());
